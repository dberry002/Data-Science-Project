...
Average Mean Squared Error (MSE): -16.179

-   This means predictions were off by about 4 points per season

# Top Predictors from Lasso:

1.  Mid-season points (14.48)

-   For every 1 standard deviation increase in mid-season points, final
    points increase by 14.48.

2.  Losses (-5.64)

3.  Attack-Defense Ratio (3.70)

4.  Goals Against (-1.76)

The inputs were standardized so an interpration if the

## Less Important Features:

-   Team categories (Aggressive, Defensive, etc.)

-   Raw counts of Wins and Goals Scored
...
-   **Feature Selection**: LASSO automatically zeroed out less important
    predictors, focusing on mid-season points, losses, and defensive
    metrics.
...
-   **Model Progression**:
    ...
    -   Lasso Regression (MSE ≈ 16.2, \~4 points off per team)
